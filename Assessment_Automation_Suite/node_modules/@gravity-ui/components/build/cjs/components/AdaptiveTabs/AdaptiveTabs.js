...
class AdaptiveTabs extends react_1.default.Component {
    ...
    constructor(props) {
        ...
        this.renderTabItem = (item, tabIndex) => {
            ...
            const maxWidth = dimensionsWereCollected && typeof this.overflownTabsCurrentWidth[tabIndex] === 'number'
                ? this.overflownTabsCurrentWidth[tabIndex] - this.tabItemPaddingRight
    ...
    renderSelect() {
        ...
        return (react_1.default.createElement(uikit_1.Select, Object.assign({ open: isSelectOpened, onUpdate: this.onChooseTabFromSelect, options: itemsForSelect, value: [], filterable: false, renderControl: this.renderSwitcherForMoreSelect, onOpenChange: this.handleOpenSelectChange }, moreControlProps)));
    }
    renderTabsAsSelect() {
        const activeTabID = this.activeTab;
        const { items } = this.props;

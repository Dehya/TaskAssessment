            ...
            react_1.default.createElement("div", { className: b('right-top-part') },
                react_1.default.createElement("div", { className: b('right-meta-and-title') },
                    react_1.default.createElement("div", { className: b('right-meta') },
                        (source === null || source === void 0 ? void 0 : source.title)
                            ? renderSourceTitle({
                                title: source.title,
                                href: source.href,
                                id: titleId,
...
function renderSourceTitle({ title, href, id }) {
    return href ? (react_1.default.createElement(uikit_1.Link, { className: b('right-source-title'), href: href, target: "_blank", title: title, id: id }, title)) : (react_1.default.createElement("div", { className: b('right-source-title'), title: title, id: id }, title));
}
function renderSourceIcon(source, titleId) {
    const iconElement = getIconElement(source);
    if (!iconElement)
        return null;
    return source.href ? (react_1.default.createElement(uikit_1.Link, { href: source.href, target: "_blank", extraProps: { 'aria-labelledby': titleId } }, iconElement)) : (iconElement);
}

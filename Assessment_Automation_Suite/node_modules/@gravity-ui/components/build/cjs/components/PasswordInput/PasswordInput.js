...
const PasswordInput = (props) => {
    ...
    const additionalEndContent = react_1.default.useMemo(() => {
        ...
        return (react_1.default.createElement("div", { className: b('additional-right-content') },
            ...
            value && showCopyButton ? (react_1.default.createElement(uikit_1.ClipboardButton, { view: "flat-secondary", text: value, hasTooltip: hasCopyTooltip, size: actionButtonSize, className: b('copy-button') })) : null,
            showRevealButton ? (react_1.default.createElement(uikit_1.ActionTooltip, { disabled: !hasRevealTooltip, title: hideValue ? (0, i18n_1.i18n)('label_show-password') : (0, i18n_1.i18n)('label_hide-password') },

...
const StoreBadge = (_a) => {
    ...
    const iconLabelData = badgeLabelData === null || badgeLabelData === void 0 ? void 0 : badgeLabelData[platform][lang];
    if (!iconData) {
        return null;
    }
    if (!href) {
        ...
        react_1.default.createElement("div", { role: "button", onClick: onClick, "aria-label": iconLabelData },
            react_1.default.createElement(uikit_1.Icon, { className: b(null, className), data: iconData })));
    }
    return (react_1.default.createElement(uikit_1.Link, Object.assign({ className: b(null, className), onClick: onClick, href: href, target: "_blank", rel: "noopener" }, restLinkProps, { extraProps: Object.assign({ 'aria-label': iconLabelData }, restLinkProps.extraProps) }),

...
export const PasswordInput = (props) => {
    ...
    const additionalEndContent = React.useMemo(() => {
        ...
        return (React.createElement("div", { className: b('additional-right-content') },
            ...
            value && showCopyButton ? (React.createElement(ClipboardButton, { view: "flat-secondary", text: value, hasTooltip: hasCopyTooltip, size: actionButtonSize, className: b('copy-button') })) : null,
            showRevealButton ? (React.createElement(ActionTooltip, { disabled: !hasRevealTooltip, title: hideValue ? i18n('label_show-password') : i18n('label_hide-password') },

...
export const StoreBadge = (_a) => {
    ...
    if (!href) {
        ...
        React.createElement("div", { role: "button", onClick: onClick, "aria-label": iconLabelData },
            React.createElement(Icon, { className: b(null, className), data: iconData })));
    }
    return (React.createElement(Link, Object.assign({ className: b(null, className), onClick: onClick, href: href, target: "_blank", rel: "noopener" }, restLinkProps, { extraProps: Object.assign({ 'aria-label': iconLabelData }, restLinkProps.extraProps) }),

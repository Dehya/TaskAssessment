...
const b$1 = cn.block('composite-bar-highlighted-item');
...
const HighlightedItem = ({ iconRef, iconNode, onClick, onClickCapture, }) => {
    ...
    const handleResizeDebounced = React.useMemo(() => debounce.debounce_1(() => {
        var _a;
    ...
    return (React__default["default"].createElement(uikit.Portal, null,
        React__default["default"].createElement("div", { className: b$1(), style: { left, top, width, height }, onClick: onClick, onClickCapture: onClickCapture, "data-toast": true },
            React__default["default"].createElement("div", { className: b$1('icon') }, iconNode))));
};
...
const Item = (props) => {
    ...
    const iconSize = item.iconSize || constants.ASIDE_HEADER_ICON_SIZE;
...
function CollapsedPopup({ onItemClick, collapseItems, anchorRef, onClose, }) {
    ...
    return (collapseItems === null || collapseItems === void 0 ? void 0 : collapseItems.length) ? (React__default["default"].createElement(uikit.Popup, { placement: POPUP_PLACEMENT, open: true, anchorRef: anchorRef, onClose: onClose },
        React__default["default"].createElement("div", { className: b('collapse-items-popup-content') },
            React__default["default"].createElement(uikit.List, { itemClassName: b('root-collapse-item'), items: collapseItems, selectedItemIndex: getSelectedItemIndex(collapseItems), itemHeight: POPUP_ITEM_HEIGHT, itemsHeight: collapseItems.length * POPUP_ITEM_HEIGHT, virtualized: false, filterable: false, sortable: false, onItemClick: onClose, renderItem: (collapseItem) => {
...
//# sourceMappingURL=Item-7c1b54f5.js.map

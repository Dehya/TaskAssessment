...
const b$4 = block('action-bar-group');
const ActionBarGroup = ({ children, className, pull }) => {
    return (React__default.createElement("ul", { className: b$4({ pull }, className), role: "group" }, children));
};
...
const b$3 = block('action-bar-item');
const ActionBarItem = ({ children, className, pull, spacing = true }) => {
    return (React__default.createElement("li", { className: b$3({ pull, spacing }, className), role: "menuitem" }, children));
};
...
const b$2 = block('action-bar-section');
const ActionBarSection = ({ children, type = 'primary' }) => {
    return (React__default.createElement("div", { className: b$2({ type }), role: "menu" }, children));
};
...
const b$1 = block('action-bar-separator');
const ActionBarSeparator = () => {
    return React__default.createElement("li", { role: "separator", className: b$1(), "aria-hidden": true });
};
...
export { PublicActionBar as P };
//# sourceMappingURL=ActionBar-834b178a.js.map

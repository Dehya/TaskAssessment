...
import { C as COLLAPSE_ITEM_ID, g as getItemsMinHeight, a as getAutosizeListItems, b as getSelectedItemIndex, c as getItemHeight, d as getItemsHeight, i as isMenuItem, I as Item, e as getMoreButtonItem } from './Item-fb2a4efc.js';
...
const AllPagesListItem = (props) => {
    ...
    return (React__default.createElement("div", { className: b$5(), onClick: onItemClick },
...
const AllPagesPanel = (props) => {
    ...
    return (React__default.createElement(Flex, { className: b$4(null, className), gap: "5", direction: "column" },
        ...
        React__default.createElement(Flex, { className: b$4('content'), gap: "5", direction: "column" }, Object.keys(groupedItems).map((category) => {
...
const Header = () => {
    ...
    return (React__default.createElement("div", { className: b$6('header', { ['with-decoration']: headerDecoration }) },
        ...
        React__default.createElement(Icon, { data: headerDividerCollapsedIcon, className: b$6('header-divider'), width: ASIDE_HEADER_COMPACT_WIDTH, height: HEADER_DIVIDER_HEIGHT })));
};
...
//# sourceMappingURL=PageLayoutAside-0c0d6943.js.map

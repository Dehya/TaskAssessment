...
class TestplaneTestAdapter {
    ...
    createTestResult(opts) {
        const { status, assertViewResults, error, sessionId, meta, attempt = constants_1.UNKNOWN_ATTEMPT } = opts;
        ...
        return testplane_1.TestplaneTestResultAdapter.create(test, { attempt, status });
    }
}

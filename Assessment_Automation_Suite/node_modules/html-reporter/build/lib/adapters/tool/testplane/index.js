...
const testplane_1 = require("../../test-collection/testplane");
const testplane_2 = require("../../config/testplane");
...
class TestplaneToolAdapter {
    ...
    constructor(opts) {
        ...
        this._config = testplane_2.TestplaneConfigAdapter.create(this._tool.config);
    ...
    async readTests(paths, cliTool) {
        ...
        return testplane_1.TestplaneTestCollectionAdapter.create(testCollection);
    }

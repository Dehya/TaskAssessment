export function fetchDataFromDatabases(dbJsonUrls: any): Promise<(string | import("./common").DbLoadResult)[]>;
export function mergeDatabases(dataForDbs: any): Promise<any>;
export function connectToDatabase(dbUrl: any): Promise<any>;

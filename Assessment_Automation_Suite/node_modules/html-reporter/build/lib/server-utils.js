...
function logPathToHtmlReport(pluginConfig) {
    ...
    common_utils_1.logger.log(`To open it use: ${chalk_1.default.yellow('npx hermione gui')} or ${chalk_1.default.yellow(`npx http-server ${pluginConfig.path}`)}`);
}
...
const formatTestResult = (rawResult, status, attempt = constants_1.UNKNOWN_ATTEMPT) => {
    return new testplane_1.TestplaneTestResultAdapter(rawResult, { attempt, status });
};
